...
from ltspipe.steps.triggers import ActionInitTriggerStep, WsInitTriggerStep
from tests.fixtures import TEST_COMPETITION_CODE
from tests.helpers import build_magic_step
from tests.mocks.logging import FakeLogger


class TestActionInitTriggerStep:
    """Test ltspipe.steps.triggers.ActionInitTriggerStep class."""
    ...
    def test_run_step(self) -> None:
        ...
        # Create an instance of ActionInitTriggerStep
        fake_logger = FakeLogger()
        step = ActionInitTriggerStep(
            logger=fake_logger,
