...
PARSERS_SETTINGS = {
    ParserSettings.TIMING_LAP: 'timing-lap-value',
}
...
def _mock_response_put_timing_lap(api_url: str) -> List[MapRequestItem]:
    """Get mocked response."""
    return [
        MapRequestItem(
            url=f'{api_url}/v1/c/1/timing/teams/1/lap',
...
def _apply_mock_api(mocker: MockerFixture, api_url: str) -> None:
    ...
    requests_map = (
        ...
        + _mock_response_put_timing_lap(api_url))
