...
PARSERS_SETTINGS = {
    ParserSettings.TIMING_NUMBER_PITS: 'timing-number-pits-value',
}
...
def _mock_response_put_timing_number_pits(api_url: str) -> List[MapRequestItem]:
    """Get mocked response."""
    return [
        MapRequestItem(
            url=f'{api_url}/v1/c/1/timing/teams/1/number_pits',
...
def _apply_mock_api(mocker: MockerFixture, api_url: str) -> None:
    ...
    requests_map = (
        ...
        + _mock_response_put_timing_number_pits(api_url))
