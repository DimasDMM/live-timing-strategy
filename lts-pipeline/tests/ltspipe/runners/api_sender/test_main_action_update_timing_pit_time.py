...
PARSERS_SETTINGS = {
    ParserSettings.TIMING_PIT_TIME: 'timing-pit-time-value',
}
...
def _mock_response_get_last_pit_in_by_team(
        api_url: str) -> List[MapRequestItem]:
    """Get mocked response."""
    return [
        MapRequestItem(
            url=f'{api_url}/v1/c/1/pits/in/filter/team/1/last',
...
def _apply_mock_api(mocker: MockerFixture, api_url: str) -> None:
    ...
    requests_map = (
        ...
        + _mock_response_get_last_pit_in_by_team(api_url)
